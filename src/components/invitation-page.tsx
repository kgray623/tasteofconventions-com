...
const defaultContent: Content = {
  ...
  hero_intro:
    "You are cordially invited to join us for a very special evening of association, cultural enrichment, gift exchanges, meeting new friends, and making wonderful memories — this side of paradise. See the video below for details.",
  video_url: null,
  itinerary: [],
      ...
      <section id="itinerary" className="mx-auto max-w-3xl px-6 pt-16">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-muted-foreground">
            ...
            While we do, tasting the culture from the cuisine from a local
            restaurant is an option. To have the full experience, pre-ordering
            the cuisine is included from the convention country below.
          </p>
        </div>
      ...
      <section id="details" className="mx-auto max-w-3xl px-6 py-16 mt-8">
        ...
        <Accordion type="multiple" value={openItems} onValueChange={setOpenItems} className="w-full space-y-3">
          ...
          <AccordionItem value="food" id="food" className="border border-border rounded-2xl bg-card px-5 data-[state=open]:shadow-elegant">
            <AccordionTrigger className="hover:no-underline">
              <span className="flex items-center gap-3 text-2xl">
                <UtensilsCrossed className="w-5 h-5 text-sunset" /> Videographer
              </span>
            </AccordionTrigger>
            <AccordionContent className="pb-6 text-muted-foreground space-y-3">
          ...
          <AccordionItem value="adult-beverages" id="adult-beverages" className="border border-border rounded-2xl bg-card px-5 data-[state=open]:shadow-elegant">
            ...
            <AccordionContent className="pb-6 text-muted-foreground space-y-2">
              <p>Adult beverages will be available for purchase from the venue. Bringing alcohol is not allowed.</p>
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
