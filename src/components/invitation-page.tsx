        ...
        <div className="rounded-3xl border border-border bg-card shadow-elegant p-8 sm:p-10 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-muted-foreground max-w-md mx-auto mb-3">
              RSVP if you want to join us in person or virtually including your party size. In person space is limited. RSVP is first reserved. Once the in person space is spoken for, a waiting list will be avaiable as well as virtual attendance.
            </p>
