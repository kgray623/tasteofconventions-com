...
export const Route = createFileRoute("/preorder")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meal preorders are closed. You can still pay one of our restaurants directly and ask to be added to their wait list for the August 30, 2026 event." },
      { property: "og:title", content: "Catered meal requests · A Taste of Special Conventions" },
      { property: "og:description", content: "Meal preorders are closed — pay a restaurant directly to be added to their wait list for the August 30, 2026 evening at Eagle's Landing." },
    ],
  }),
